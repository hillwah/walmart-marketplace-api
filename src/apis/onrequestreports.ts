...
export interface InlineResponse2001 {
    ...
    /**
     * List of requests
     * @type {Array<InlineResponse2001Requests>}
     * @memberof InlineResponse2001
     */
    requests?: Array<InlineResponse2001Requests>;
}
/**
 * Request Payload
 * @export
 ...
 * 
 * @export
 * @interface InlineResponse2001Requests
 */
export interface InlineResponse2001Requests {
    /**
     * Automated ID generated by system that uniquely identifies the report request.
     * @type {string}
     * @memberof InlineResponse2001Requests
     */
    requestId?: string;
    /**
     * Status of report request. Possible values are RECEIVED, INPROGRESS, READY, ERROR.
     ...
     * @memberof InlineResponse2001Requests
     */
    requestStatus?: InlineResponse2001RequestsRequestStatusEnum;
    /**
     * Date and time on which the report request is submitted.
     * @type {string}
     * @memberof InlineResponse2001Requests
     ...
     * @memberof InlineResponse2001Requests
     */
    reportType?: InlineResponse2001RequestsReportTypeEnum;
    /**
     * Version of report for which the request is created. Example, v1.
     * @type {string}
     * @memberof InlineResponse2001Requests
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse2001RequestsRequestStatusEnum {
    Received = 'RECEIVED',
    Inprogress = 'INPROGRESS',
    Ready = 'READY',
    Error = 'ERROR'
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse2001RequestsReportTypeEnum {
    Item = 'ITEM'
}
...
export interface RequestsStatusResponse {
     ...
     * @memberof RequestsStatusResponse
     */
    requests?: Array<InlineResponse2003>;
}
/**
...
export const OnRequestReportApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async downloadReport(requestId: string, authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse200>> {
         ...
         * @throws {RequiredError}
         */
        async generateReport(reportType: 'ITEM' | 'INVENTORY', reportVersion: string, authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, contentType: string, wMCONSUMERCHANNELTYPE?: string, inlineObject?: InlineObject, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2002>> {
         ...
         * @throws {RequiredError}
         */
        async getSingleRequestStatus(requestId: string, authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, wMCONSUMERCHANNELTYPE?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2003>> {
...
export const OnRequestReportApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        downloadReport(requestId: string, authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse200> {
         ...
         * @throws {RequiredError}
         */
        generateReport(reportType: 'ITEM' | 'INVENTORY', reportVersion: string, authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, contentType: string, wMCONSUMERCHANNELTYPE?: string, inlineObject?: InlineObject, options?: any): AxiosPromise<InlineResponse2002> {
         ...
         * @throws {RequiredError}
         */
        getRequestsStatus(reportType: 'ITEM' | 'INVENTORY', authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, reportVersion?: string, requestStatus?: 'RECEIVED' | 'INPROGRESS' | 'READY' | 'ERROR', requestSubmissionStartDate?: string, requestSubmissionEndDate?: string, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2001> {
         ...
         * @throws {RequiredError}
         */
        getSingleRequestStatus(requestId: string, authorization: string, wMSECACCESSTOKEN: string, wMQOSCORRELATIONID: string, wMSVCNAME: string, accept: string, wMCONSUMERCHANNELTYPE?: string, options?: any): AxiosPromise<InlineResponse2003> {
